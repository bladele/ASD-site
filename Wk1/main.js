...
function storeData(key){
	if(!key){//if there is no key, this means this a new item and new key is needed.
		var id = Math.floor(Math.random() * 1000001);
	} else {//set the id to the existing key we're editing so it wont save over the data. 
		id = key;
	}
